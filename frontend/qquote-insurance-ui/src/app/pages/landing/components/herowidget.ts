    ...
    >
      <div class="mx-6 md:mx-20 mt-0 md:mt-6">
        <h1 class="text-6xl font-bold text-gray-900 leading-tight dark:!text-gray-700">
          <span class="font-light block">Protect What Matters Most</span>with the Right Coverage
        </h1>
        <p class="font-normal text-2xl leading-normal md:mt-4 text-gray-700 dark:text-gray-700">
          Get instant insurance quotes tailored to your needs. Life, health, auto, and home coverage
          — all in one place.
        </p>
        <button
          pButton
